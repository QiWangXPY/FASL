...
class Load_10h_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = self.test_label[index][0, :1024] #1200
        ...
        ahi_label = self.ahi_label[index][:1024] #1200
...
class Load_10h_Dataset(Dataset):
    def __init__(self, mode):
        ...
        if(self.mode == 'train'):
            ...
            #self.fea = torch.load(data_path + dataset + '/10h_input/new/'+self.mode+'_fea_conseq_200.pt').tolist()
            
            #with open(data_path + dataset + '/overall/new/'+self.mode+'_sig_conseq_40.pkl', 'rb') as f:#_500
            #    self.sig = pickle.load(f)
            self.sig = torch.load(data_path + dataset + '/overall/new/'+self.mode+'_sig_conseq_40.pt').tolist()
            #self.sig = torch.load(data_path + dataset + '/10h_input/new/'+self.mode+'_sig_conseq_200.pt').tolist()
                
            with open(data_path + dataset + '/overall/'+mode+'_ppg_40.pkl', 'rb') as f:
                self.ppg = pickle.load(f)
            #with open(data_path + dataset + '/10h_input/'+mode+'_ppg_200.pkl', 'rb') as f:
            #    self.ppg = pickle.load(f)
            ...
            #self.fea = torch.load(data_path + dataset + '/10h_input/new/'+self.mode+'_fea_conseq.pt').tolist()
            
            #with open(data_path + dataset + '/overall/new/'+self.mode+'_sig_conseq_44.pkl', 'rb') as f:
            #    self.sig = pickle.load(f)
            self.sig = torch.load(data_path + dataset + '/overall/new/'+self.mode+'_sig_conseq_44.pt').tolist()
            #self.sig = torch.load(data_path + dataset + '/10h_input/new/'+self.mode+'_sig_conseq.pt').tolist()
            
            with open(data_path + dataset +  '/overall/'+mode+'_ppg_44.pkl', 'rb') as f:
                self.ppg = pickle.load(f)
            #with open(data_path + dataset +  '/10h_input/'+mode+'_ppg.pkl', 'rb') as f:
            #    self.ppg = pickle.load(f)
            ...
            with open(data_path + dataset + '/overall/'+mode+'_label_44.pkl', 'rb') as f:
                self.test_label = pickle.load(f)
            #with open(data_path + dataset + '/10h_input/'+mode+'_label_frag.pkl', 'rb') as f:
            #    self.test_label = pickle.load(f)
            
            with open(data_path + dataset + '/overall/'+self.mode+'_ahi_label_44.pkl', 'rb') as f:
                self.ahi_label = pickle.load(f)
            #with open(data_path + dataset + '/10h_input/'+self.mode+'_ahi_label.pkl', 'rb') as f:
            #    self.ahi_label = pickle.load(f)
    ...
    def __getitem__(self, index):
        ...
        label = torch.tensor(self.test_label[index])[:1200] #1200
        ...
        ahi_label = torch.tensor(self.ahi_label[index])[:1200] #1200
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                for batch_idx, (ppg, sig, fea, label, frag_label, ahi_label) in enumerate(val_loader):
                    ...
                    y = y.long().to(device)
                    ahi_label = ahi_label.long().to(device)
